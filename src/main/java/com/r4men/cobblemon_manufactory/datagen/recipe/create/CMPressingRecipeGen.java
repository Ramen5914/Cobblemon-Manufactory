...
public final class CMPressingRecipeGen extends PressingRecipeGen {
    GeneratedRecipe SLATE_BALL_LID = itemToLid("black_ball_lid", CobblemonItems.BLACK_APRICORN, CMItems.SLATE_BALL_LID);
//    GeneratedRecipe BLACK_TUMBLESTONE_LID = itemToLid("black_tumblestone_lid", CobblemonItems.BLACK_TUMBLESTONE, CMItems.BLACK_TUMBLESTONE_LID);
    GeneratedRecipe AZURE_BALL_LID = itemToLid("blue_ball_lid", CobblemonItems.BLUE_APRICORN, CMItems.AZURE_BALL_LID);
    GeneratedRecipe VERDANT_BALL_LID = itemToLid("green_ball_lid", CobblemonItems.GREEN_APRICORN, CMItems.VERDANT_BALL_LID);
    GeneratedRecipe ROSEATE_BALL_LID = itemToLid("pink_ball_lid", CobblemonItems.PINK_APRICORN, CMItems.ROSEATE_BALL_LID);
    GeneratedRecipe POKE_BALL_LID = itemToLid("red_ball_lid", CobblemonItems.RED_APRICORN, CMItems.POKE_BALL_LID);
...
//    GeneratedRecipe TUMBLESTONE_LID = itemToLid("tumblestone_lid", CobblemonItems.TUMBLESTONE, CMItems.TUMBLESTONE_LID);
    GeneratedRecipe PREMIER_BALL_LID = itemToLid("white_ball_lid", CobblemonItems.WHITE_APRICORN, CMItems.PREMIER_BALL_LID);
    GeneratedRecipe CITRINE_BALL_LID = itemToLid("yellow_ball_lid", CobblemonItems.YELLOW_APRICORN, CMItems.CITRINE_BALL_LID);
