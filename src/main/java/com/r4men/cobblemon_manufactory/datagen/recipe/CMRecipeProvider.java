package com.r4men.cobblemon_manufactory.datagen.recipe;
...
public class CMRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    public @NotNull String getName() {
        return CobblemonManufactory.NAME + "'s Recipes";
    }
    ...
    protected void buildRecipes(@NotNull RecipeOutput recipeOutput) {
        ...
        simpleStonecutterRecipe(CMBlocks.EXP_QUARTZ_BLOCK, CMBlocks.EXP_QUARTZ_TILES, recipeOutput);
        simpleStonecutterRecipe(CMBlocks.EXP_QUARTZ_BLOCK, CMBlocks.SMALL_EXP_QUARTZ_TILES, recipeOutput);
    }
